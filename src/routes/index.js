function setRoutes(app) {
    ...
    app.post('/carrinho/add', carrinhoController.addItem.bind(carrinhoController));
    app.delete('/carrinho/remove/:id', carrinhoController.removeItem.bind(carrinhoController));
